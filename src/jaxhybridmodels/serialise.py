...
def _resolve_version() -> str:
    """Return the installed ``jax-hybridmodels`` version, or ``"unknown"``.
    ...
    """
    try:
        return ilm.version("jax-hybridmodels")
...
def load_run(
    ...
    *,
    ...
    if (
        ...
        raise ValueError(
            f"Saved run targets jax-hybridmodels version {saved_version!r}, "
