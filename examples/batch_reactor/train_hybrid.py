...
Single-file end-to-end script implementing the design in
``examples/batch_reactor/SPEC.md``.
...
def _build_predictors(*, key: Array) -> tuple[ArrheniusKinetics, BoundedPredictor]:
...
def main() -> None:
    ...
    # ---- Predictors -------------------------------------------------------- #
    print("\n[build] predictors")
    predictors = _build_predictors(key=k_init)
